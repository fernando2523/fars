...
export default function Shipping() {
  ...
  async function loaddataorder(
    ...
    await axios({
      method: "post",
      url: `https://api.supplysmooth.id/v1/orderresellerretail`,
      data: {
  ...
  async function ordercount(store: any, query: any, date: any, area: any) {
    await axios({
      method: "post",
      url: `https://api.supplysmooth.id/v1/ordercountresellerretail`,
      data: {
        store: store,
        query: query,
        date: date,
  ...
  async function getheaderpesanan(
    ...
    await axios({
      method: "post",
      url: `https://api.supplysmooth.id/v1/getheaderpesananresellerretail`,
      data: {
        status_pesanan: status_pesanan,
        query: query,
        store: store,
  ...
  async function getwarehouse(role: any, area: any) {
    await axios({
      method: "post",
      url: `https://api.supplysmooth.id/v1/gudangretur`,
      data: {
        role: role,
        area: area,
      },
  ...
  async function getstore(role: any, area: any) {
    await axios({
      method: "post",
      url: `https://api.supplysmooth.id/v1/getStore_salesretail`,
      data: {
        role: role,
        store: area,
      },
