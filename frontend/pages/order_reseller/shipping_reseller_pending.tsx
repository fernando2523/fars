...
export default function Shipping() {
  ...
  async function ordercount(store: any, query: any, date: any) {
    await axios({
      method: "post",
      url: `${process.env.NEXT_PUBLIC_HOST}/v1/ordercountresellerpending`,
      data: {
        store: store,
        query: query,
        date: date,
  ...
  async function getheaderpesanan(
    ...
    await axios({
      method: "post",
      url: `${process.env.NEXT_PUBLIC_HOST}/v1/getheaderpesananresellerpending`,
      data: {
        status_pesanan: status_pesanan,
        query: query,
        store: store,
  ...
  async function getstore(role: any) {
    await axios({
      method: "post",
      url: `${process.env.NEXT_PUBLIC_HOST}/v1/getstore_sales`,
      data: {
        role: role,
      },
    })
                  ...
                  rows.push(
                    ...
                    >
                      <Image
                        ...
                        src={`${process.env.NEXT_PUBLIC_HOST}/public/images/${order.details_order[i - 1].img
                          }`}
                        alt="product-1"
                        height="500"
                        width="500"
  ...
  async function openmodalpaysatuan(
    ...
    await axios
      .post(`${process.env.NEXT_PUBLIC_HOST}/v1/gethistorypay`, {
                  ...
                  <div className="basis-1/3 text-xl font-bold p-5 text-lime-500 ">
                    <div className="mt-1">
                      <Image
                        ...
                        src={`${process.env.NEXT_PUBLIC_HOST}/public/images/cash1.png`}
                ...
                <div className="flex flex-row">
                  <div className="basis-1/3 text-xl font-bold p-5 text-blue-600">
                    <div className="mt-1">
                      <Image
                        className="w-[40%] h-[25%] m-auto"
                        src={`${process.env.NEXT_PUBLIC_HOST}/public/images/bca1.png`}
                        alt="Picture of the author"
                        width={100}
                        height={100}
                        placeholder="blur"
