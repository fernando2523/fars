...
export default function Shipping() {
  ...
  async function loaddataorder(
    ...
    await axios({
      method: "post",
      url: `https://api.supplysmooth.id/v1/orderresellerpending`,
      data: {
  ...
  async function ordercount(store: any, query: any, date: any) {
    await axios({
      method: "post",
      url: `https://api.supplysmooth.id/v1/ordercountresellerpending`,
      data: {
        store: store,
        query: query,
        date: date,
  ...
  async function getheaderpesanan(
    ...
    await axios({
      method: "post",
      url: `https://api.supplysmooth.id/v1/getheaderpesananresellerpending`,
      data: {
        status_pesanan: status_pesanan,
        query: query,
        store: store,
  ...
  async function getstore(role: any) {
    await axios({
      method: "post",
      url: `https://api.supplysmooth.id/v1/getstore_sales`,
      data: {
        role: role,
      },
    })
  ...
  async function sumbitReturLuar() {
    if (
      ...
      await axios
        .post(`https://api.supplysmooth.id/v1/returLuar`, {
  ...
  async function getStock(e: any) {
    ...
    if (e.target.value === "") {
      ...
      await axios
        .post(`https://api.supplysmooth.id/v1/getsizeretur`, {
  ...
  async function sumbitRetur() {
    await axios
      .post(`https://api.supplysmooth.id/v1/retur`, {
  ...
  async function sumbitrefund() {
    setbtnrefund(true);
    await axios
      .post(`https://api.supplysmooth.id/v1/refund`, {
        id_produk: id_produkretur,
                  ...
                  rows.push(
                    ...
                    >
                      <Image
                        ...
                        src={`https://api.supplysmooth.id/public/images/${order.details_order[i - 1].img
                          }`}
                        alt="product-1"
                        height="500"
                        width="500"
  ...
  async function openmodalpaysatuan(
    ...
    await axios
      .post(`https://api.supplysmooth.id/v1/gethistorypay`, {
  ...
  async function updatePesanan(status: any) {
    await axios
      .post(`https://api.supplysmooth.id/v1/updatepesanan`, {
        id_pesanan: id_pesanan,
        status,
      })
      .then(function (response) {
  ...
  async function deletePesanan() {
    await axios
      .post(`https://api.supplysmooth.id/v1/deletepesanan`, {
        id_pesanan: id_pesanan,
        status: tabactive,
      })
      .then(function (response) {
                  ...
                  <div className="basis-1/3 text-xl font-bold p-5 text-lime-500 ">
                    <div className="mt-1">
                      <Image
                        ...
                        src={`https://api.supplysmooth.id/public/images/cash1.png`}
                ...
                <div className="flex flex-row">
                  <div className="basis-1/3 text-xl font-bold p-5 text-blue-600">
                    <div className="mt-1">
                      <Image
                        className="w-[40%] h-[25%] m-auto"
                        src={`https://api.supplysmooth.id/public/images/bca1.png`}
                        alt="Picture of the author"
                        width={100}
                        height={100}
                        placeholder="blur"
                ...
                <div className="flex flex-row">
                  <div className="basis-1/3 text-xl font-bold p-5 text-cyan-500">
                    <div className="mt-1">
                      <Image
                        className="w-[40%] h-[25%] m-auto"
                        src={`https://api.supplysmooth.id/public/images/qris.jpeg`}
                        alt="Picture of the author"
                        width={100}
                        height={100}
                        placeholder="blur"
