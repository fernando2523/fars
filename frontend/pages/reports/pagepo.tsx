...
export default function PageSo() {
  ...
  async function loaddatapo(query: any, tanggal: any, Filter_Tipe_po: any, Filter_Supplier: any, Filter_Tipe_user: any, user_role: any, user_store: any, Brand: any) {
    ...
    await axios({
      method: "post",
      url: `https://api.supplysmooth.id/v1/getpo`,
      data: {
        query: query,
        date: tanggal,
  ...
  async function getusers(user_login: any, user_role: any, user_store: any) {
    ...
    await axios({
      method: "post",
      url: `https://api.supplysmooth.id/v1/getuserpo`,
      data: {
  ...
  async function deleteData() {
    await axios
      .post(`https://api.supplysmooth.id/v1/deleteitempo`, {
        id_act: id_act,
        users: Name,
      })
      .then(function (response) {
  ...
  async function showrepeatModal(
    ...
    await axios
      .post(`https://api.supplysmooth.id/v1/get_sizepo`, {
        id_act: id_act,
      })
      .then(function (response) {
  ...
  const onSubmitedit = async (data: any) => {
    ...
    if (qty_all === 0) {
      ...
      await axios
        .post(`https://api.supplysmooth.id/v1/editpo`, {
          data: data,
          id_act: id_act,
          idpo: edit_idpo,
